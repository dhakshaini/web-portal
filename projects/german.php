...
$con = mysqli_connect("localhost","root","saran","pet_booking");
 if($con->connect_error){
   die("connection failed:".$conn->connection_error);
	...
	$result = mysqli_query($con, "SELECT * FROM dog_details WHERE Name= 'German_Sepherd'");
  ?>
 <!DOCTYPE html>
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     <div class="details">
       ...
       <div class="det">
          <output type="text" name="name" value="Name :">In Stock : <?php echo $row['In_Stock']; ?></output>
       </div>
       <div class="det">
   ...
   <a href='demo.php'>
   <input class="btn" type="submit" name="book" value="BOOK">
   </a>
</div>
